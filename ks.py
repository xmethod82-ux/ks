...
OWNER_ID =7804028677
ADMIN_ID = 7804028677
YOUR_USERNAME = "@shakil_edit"
UPDATE_CHANNEL = "https://t.me/CodeNestup"

# Safety check
if not TOKEN:
    raise ValueError("BOT_TOKEN is missing! Please set BOT_TOKEN environment variable.")
